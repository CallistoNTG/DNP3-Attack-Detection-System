...
def sniffer():
    ...
    sniff(count=0, iface=conf.iface, prn=pkt_action, store=0)
...
if __name__ == "__main__":
    ...
    config = configparser.ConfigParser(inline_comment_prefixes=';')  # Reference values in config.ini
    ...
    yyy = config.get('Constants', 'windowLength')
    ...
    from DNP3_Lib.DNP3_Lib import DNP3 as myDNP3
    DNP3 = myDNP3  # Reference to DNP3 class defined in DNP3_Lib
